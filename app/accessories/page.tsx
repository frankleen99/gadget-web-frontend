    ...
    <div>
      ...
      <div className="min-h-screen px-4 sm:px-6 lg:px-8 mt-2 p-6">
        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6 bg-[#fff] px-2 md:px-4">
            {products.map((product) => (
              <div
                key={product.id}
                className="rounded-[16px] p-2 md:p-3 shadow-md hover:shadow-lg transition-shadow bg-[#fff] border border-gray-300 overflow-hidden cursor-pointerw-full flex flex-col"
